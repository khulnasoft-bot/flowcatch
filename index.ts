...
class Client {
  ...
  static async createChannel({ fetch = global.fetch } = {}) {
    const response = await fetch("https://flowcatch.io/new", {
      method: "HEAD",
      redirect: "manual",
    });
  ...
  async onmessage(msg: any) {
    ...
    // See https://github.com/khulnasoft-bot/flowcatch/issues/295
    // See https://github.com/khulnasoft-bot/flowcatch/issues/187
    delete headers["host"];
